...
# Usage: Run this script in your terminal, ensuring APP and ASSET_DIRS are set.
# ================================================================================
...
# Check if APP is set
: "${APP:?APP must be set (e.g. APP='APP_')}"
...
# Iterate through each environment variable that starts with APP
env | grep "^${APP}" | while IFS='=' read -r key value; do
