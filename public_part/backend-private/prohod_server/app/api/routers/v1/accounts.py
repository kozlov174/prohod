...
async def deactivate_user(
    ...
    account_service = await AccountsService(request, db).deactivate_user()

    return {"status": "deacticated"}
...
async def deactivate_user(
    ...
    account_service = await AccountsService(request, db).activate_user()

    return {"status": "acticated"}
