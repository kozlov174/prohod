...
export function VisitRequestPage() {
  ...
  const { mutateAsync: createVisit } = useMutation({
    mutationFn: (data: FormState) => {
      ...
      // Используем Date.UTC для создания timestamp в UTC
      const visitTimestamp = Date.UTC(year, month - 1, day, hours, minutes)
      ...
      <Container>
        <Card>
          ...
          >
            ...
            <FormGroup title="3. Куда придёт QR-код для посещения">
              <SendCodeControl
